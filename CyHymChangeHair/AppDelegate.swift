...
enum AdjustKey: String {
    case AdjustKeyAppToken = "qzq26bwqmygw"
    case AdjustKeyAppLaunch = "h71jg6"
    case AdjustKeyAppCoinsBuy = "vwty3m"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var mainVC: CyHMainVC = CyHMainVC()
...
//        com.inshair.Cardiyle
        
        NotificationCenter.default.post(name: .water,
                                        object: [
                                            HightLigtingHelper.default.debugBundleIdentifier = "com.inshair.Cardiyle",
