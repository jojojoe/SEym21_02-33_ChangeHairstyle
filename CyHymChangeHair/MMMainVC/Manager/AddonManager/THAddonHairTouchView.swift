...
class THAddonHairTouchView: TouchStuffView {
...
extension THAddonHairTouchView {
    func setupView() {
...
extension THAddonHairTouchView {
    func setupActionBtns() {
        ...
        deleteBtn.setImage(UIImage(named: "delete_ic"), for: .normal)
        deleteBtn.addTarget(self, action: #selector(deleteBtnClick(_:)) , for: UIControl.Event.touchUpInside)
        addSubview(deleteBtn)
        
        rotateBtn = UIImageView.init(image: UIImage.init(named: "adjust_pic_ic"))
