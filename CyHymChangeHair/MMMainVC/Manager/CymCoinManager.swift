...
//            coinCount = KeychainSaveManager.readCoinFromKeychain()
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.inshair.Cardiyle.listone", coin: 100, price: "$0.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.inshair.Cardiyle.listtwo", coin: 300, price: "$1.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.inshair.Cardiyle.listthree", coin: 600, price: "$3.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.inshair.Cardiyle.listfour", coin: 1000, price: "$5.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.inshair.Cardiyle.listfive", coin: 2000, price: "$9.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.inshair.Cardiyle.listsix", coin: 3000, price: "$12.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.inshair.Cardiyle.listseven", coin: 4500, price: "$16.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.inshair.Cardiyle.listeight", coin: 5000, price: "$19.99", color: "#C9FFEE")
