...
extension CyHStoreVC: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: 140, height: 342/2)
    }
...
class IHymStoreCell: UICollectionViewCell {
    ...
    func setupView() {
        ...
        bgImageV.image = UIImage(named: "store_coins_bg_ic")
        ...
        coinCountLabel.font = UIFont(name: "Lexend-Bold", size: 20)
        coinCountLabel.adjustsFontSizeToFitWidth = true
        ...
        priceLabel.font = UIFont(name: "Lexend-Bold", size: 16)
